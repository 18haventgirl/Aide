...
export function AgentPanel({
  ...
  return (
    <div className="w-full h-full min-w-0 flex flex-col bg-transparent">
      ...
      <div className="flex-1 min-h-0 min-w-0 overflow-y-auto p-4 md:p-6 bg-gray-50 space-y-4 md:space-y-6">
